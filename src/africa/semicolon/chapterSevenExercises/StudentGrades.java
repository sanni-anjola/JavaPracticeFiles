...
public class StudentGrades {
    public static void main(String[] args) {
        ...
        fillScores(inputCollector, numberOfSubjects, scores);
        displayScores(numberOfSubjects, scores);
    }

    private static void displayScores(int numberOfSubjects, int[][] scores) {
        int student;
        System.out.println("\n################ Display Scores ########################\n");
    ...
    private static void fillScores(Scanner inputCollector, int numberOfSubjects, int[][] scores) {
        System.out.println("\n################ Collecting Scores ########################\n");
        int score;
        int student = 1;
        for(int[] students : scores){
